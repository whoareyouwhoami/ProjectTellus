...
Django settings for Project Tellus.
...
INSTALLED_APPS = [
    ...
    'kickstart.apps.KickstartConfig',
]
...
ROOT_URLCONF = 'SW4DS_django.urls'
...
WSGI_APPLICATION = 'SW4DS_django.wsgi.application'
